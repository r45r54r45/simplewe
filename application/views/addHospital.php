...
<div class="container" ng-controller="add_hospital" ng-init="init();">
...
<div class="row row-eq-height" style="margin-top:10px;">
  ...
  <div class="row" >
    <div class="col-xs-12 col-sm-6" style="margin-bottom:20px;" id="useThisHeight">
