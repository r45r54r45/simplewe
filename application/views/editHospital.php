...
<div class="container" ng-controller="edit_hospital" ng-init="init(<?=$hid?>)">
            ...
            <div class="search-result-area col-xs-12 col-sm-6">
              <div class="" style="margin-bottom:10px;">
                <div style="display:inline-block" class="search-result-title" >
                  <input class="embedded_input"  type="text" id="hos_title"  placeholder="HOSPITAL NAME" ng-model="hospital_data.hospital[0].NAME">
                </div>
              ...
              <div class="">
                <div style="display:inline-block; width:100%"  class="search-result-body">
                  ...
                  placeholder="HOSPITAL DESCRIPTION" ng-model="hospital_data.hospital[0].DESCRIPTION"></textarea>
                </div>
              ...
              <div class="">
                <div class="text-center" style="font-weight:600; font-size:15px; color:white;">
                  <input class="form-control embedded_input"
                   placeholder="position"  ng-model="hospital_data.hospital[0].ORDERING">
  ...
  <!-- added doctor -->
  <div class="col-xs-6 col-sm-3" ng-repeat="i in hospital_data.doctor" style="margin-bottom: 15px;" ng-click="edit_doctor(i)">
    <div class="profile_area text-center" style="border-radius:50%; height: 100px;
    width: 100px;position: relative;
    overflow: hidden;margin:auto;">
    <img ng-src="{{i.PROFILE}}" class="img img-circle" style="position: absolute;
    left: 0;
    top: 0;
    width: 100px;"/>
  </div>
    ...
    <div class="search-result-block relative" style="height: auto; margin-bottom:0px;">
      <div class="media">
        <div class="media-left" style="padding: 30px 20px;">
          ...
          overflow: hidden">
          <img id="add_doctor_image_temp" ng-src="{{doctor_info.PROFILE}}" style="    position: absolute;
          top: 0;
          left: 0;
          width: 100px;"/>
      ...
      <div class="media-body" style="padding: 20px 10px;">
        <div style="display:inline-block" class="search-result-title"
        >
        <input class="embedded_input"  type="text" id="d_name"  placeholder="DOCTOR NAME" ng-model="doctor_info.NAME">
      </div>
      ...
      <div style="font-size: 12px; color:white; margin-top:10px;margin-right:10px;">
        ...
        height: 100px;"  ng-model="doctor_info.DESCRIPTION"></textarea>
